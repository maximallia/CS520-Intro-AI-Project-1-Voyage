...
#Weighted Astar
#-----------------------
def w_AStar(s, g, type_h, wall_list):
...
while runnable:
    ...
    if type_s == 'S':
        ...
        path, temp_wall, temp_visited = w_AStar(s_grid, g_grid, type_h, wall_list)
        ...
        if path == []:
            ...
            if len(wall_list) == 0:
                ...
                path, temp_wall, temp_visited = w_AStar(visited_list[-1], g_grid, type_h, wall_list)
